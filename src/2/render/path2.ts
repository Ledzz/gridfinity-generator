...
import {BufferGeometry, Color, DoubleSide, Matrix4, Mesh, MeshBasicMaterial, Shape, ShapeGeometry} from "three";

function createClosedPolygonGeometry(jsonData: Path2) {
...
export function createClosedPolygonObject(jsonData: Path2) {
    const geometry = createClosedPolygonGeometry(jsonData);
